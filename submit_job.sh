...
#
HUGGINGFACE_HUB_CACHE="/scratch3/koo01a/huggingface/hub" HF_DATASETS_CACHE="/scratch3/koo01a/huggingface/hub" ACCELERATE_USE_FSDP=1 FSDP_CPU_RAM_EFFICIENT_LOADING=1 python run.py 
